...
app.get("/bookings", verify, async (req, res) => {
  ...
  try {
    ...
    if (bookingDate && bookingTime) {
      ...
      query =
        "SELECT booking.id, booking.description, booking_email, booking_phone, booking.booking_date, booking.booking_time, booking.booking_timestamp, booking.is_emailed, booking.uid, users.username FROM booking INNER JOIN users ON booking.uid = users.id WHERE booking_date = $1 AND booking_time = $2";
      ...
      query =
        "SELECT booking.id, booking.description, booking_email, booking_phone, booking.booking_date, booking.booking_time, booking.booking_timestamp, booking.is_emailed, booking.uid, users.username FROM booking INNER JOIN users ON booking.uid = users.id WHERE booking_date = $1";
